...
export const zh = {
  ...
  'ask.reject': '拒绝回答',
  'ask.failed': '提交失败，请重试',
  'ask.loadFailed': '待回答的问题未能同步，请重新打开会话重试',
  'ask.sending': '正在提交…',
  ...
  'item.memory': '内存',
  'memory.release': '释放缓存',
  'memory.releasing': '释放中…',
  'memory.released': '已释放 {count} 项,约 {bytes}',
  'memory.releaseFailed': '释放失败:{reason}',
  'memory.readFailed': '读取失败:{reason}',
  'memory.loading': '正在读取…',
  'memory.totalUnknown': '总量未知',
  'memory.pressureOk': '正常',
  'memory.pressureSoft': '超过软上限',
  'memory.pressureHard': '超过硬上限',
  'memory.pressureUnknown': '无法测量',
  'memory.partial': '部分进程无法测量,总量偏低',
  'memory.processes': '进程',
  'memory.noProcesses': '没有可测量的进程',
  'memory.unmeasured': '无数据',
  'memory.holders': '缓存',
  'memory.unitSessions': '{count} 个会话',
  'memory.unitEvents': '{count} 条',
  'memory.unitViews': '{count} 个网页',
  'memory.releaseHint': '释放可以重新生成的缓存,包括后台网页和不在使用的会话。释放后再次打开需要重新加载。',
  'memory.budgetLabel': '内存占用',
  'memory.overview': '内存概览',
  'memory.totalLabel': '总占用',
  'memory.trendWindow': '近 5 分钟',
  'memory.processCount': '共 {count} 个',
  'memory.trend': '占用趋势',
  'memory.trendWarming': '正在采集数据',
  'memory.trendSummary': '近 {minutes} 分钟 · 最低 {low} · 最高 {high}',
  'memory.agoNow': '刚刚',
  'memory.agoSeconds': '{count} 秒前',
  'memory.agoMinutes': '{count} 分钟前',
  'memory.composition': '占用分布',
  'memory.catCore': '核心',
  'memory.catUi': '界面',
  'memory.catWeb': '网页',
  'memory.catSystem': '系统服务',
  'memory.catCoreHint': '主进程,负责会话、工具调用、搜索索引与后台任务',
  'memory.catUiHint': '应用窗口的渲染进程',
  'memory.catWebHint': '内置浏览器打开的网页。每个标签页占用一个进程,页面中嵌入的其他网站各自再占用一个进程',
  'memory.catSystemHint': 'Chromium 的 GPU、网络、音频等服务进程',
  'memory.holdersHint': '以下缓存都可以重新生成。内存超过上限时会自动释放,也可以点击「释放缓存」手动释放。',
  'memory.holderFill': '{name}用量',
  'memory.nameCore': '主进程',
  'memory.nameNetwork': '网络服务',
  'memory.nameAudio': '音频服务',
  'memory.nameStorage': '存储服务',
  'memory.detailSessions': '{count} 个会话',
  'memory.detailCapacityPerSession': '每个会话最多保留 {count} 条',
  'memory.detailIdle': '{count} 个未在使用',
  'memory.detailProtected': '{count} 个正在使用',
  'memory.detailTabs': '共 {count} 个标签页',
  'memory.detailHidden': '{count} 个在后台',
  'memory.detailAudible': '{count} 个正在播放声音',
  'memory.detailHibernated': '已自动释放 {count} 次',
  'memory.hardLine': '硬上限',
  'memory.softLine': '软上限',
  ...
  'chat.images.group': '{count} 张图片',
  'chat.image.view': '查看 {name}',
  ...
  'settings.sectionNetwork': '网络代理',
  'network.enable': '使用网络代理',
  'network.hint': '修改自动保存，对应用和内置浏览器的新请求生效，无需重启。',
  'network.url': '代理地址',
  'network.urlHint': '支持 HTTP、HTTPS 和 SOCKS5。停止输入后自动保存，也可按回车或移开焦点立即保存。',
  'network.bypass': '不使用代理的地址',
  'network.bypassHint': '多个地址用分号或逗号分隔，例如 localhost;127.0.0.1;*.local。',
  'network.urlRequired': '请先填写代理地址，再启用代理。',
  'network.urlInvalid': '请输入有效的代理地址，例如 http://127.0.0.1:7890。',
  'network.urlProtocol': '代理地址应以 http://、https:// 或 socks5:// 开头。',
  'network.loading': '正在读取代理设置…',
  'network.loadFailed': '无法读取代理设置',
  'network.saveFailed': '尚未保存，已保留你的修改，请重试。',
  'network.pending': '等待保存修改…',
  'network.unsavedInvalid': '尚未保存，请修正代理地址后再应用修改。',
  'network.enabledStatus': '已保存 · 代理已启用',
  'network.disabledStatus': '已保存 · 代理已关闭，使用直连',
  'network.retry': '重试',
  'network.retrySave': '重新保存',
  'network.test': '测试连接',
  'network.testing': '正在测试…',
  'network.testHint': '检测能否访问 Google 连通性检查地址，10 秒后超时。',
  'network.testSuccess': '连接成功',
  'network.testFailed': '连接失败',
  ...
  'drag.hint.splitLeft': '分屏到左侧',
  'drag.hint.splitRight': '分屏到右侧',
  'drag.hint.splitTop': '分屏到上方',
  'drag.hint.splitBottom': '分屏到下方',
  ...
  'providers.reasoningMappingCustom': '自定义映射',
  'providers.reasoningInvalid': '请填写有效的映射 JSON：effortPath 为字段路径，effortValues 的值为文字或数字。',
  'providers.reasoningSave': '保存思考配置',
  'providers.reasoningReset': '恢复默认思考配置',
  'composer.thinkAlwaysOn': '此模型始终开启思考',
  ...
  'providers.overrideFoot': '窗口与能力即改即存',
  ...
  'music.untitled': '未知曲目',
  'music.playerIdle': '播放器未运行。',
  'music.intentPlaceholder': '想听什么？例如：下雨天，安静的中文民谣',
  'music.intentNow': '「{intent}」',
  'music.open': '开启电台',
  'music.retune': '切换',
  'music.retuneOpen': '切换…',
  'music.retuneHint': '切换后将重新生成播放列表，当前歌曲不受影响。',
  'music.preset.rain': '下雨天,安静点的',
  'music.preset.focus': '写代码,少点人声',
  'music.preset.friday': '周五晚上,放松一下',
  'music.preset.drive': '深夜开车回家',
  'music.radioResume': '继续播放',
  'music.radioLeft': '剩余 {count} 首',
  'music.radioStop': '关闭电台',
  'music.requestPlaceholder': '歌名 歌手',
  'music.request': '点歌',
  'music.programme': '即将播放',
  'music.programmeCount': '即将播放 · {count} 首',
  'music.programmeEmpty': '播放列表为空。',
  'music.upNext': '下一首：{title}',
  'music.starting': '正在切换：{title}',
  'music.programmeMore': '还有 {count} 首未显示',
  'music.armLabel': '唱臂',
  'music.rowMore': '更多操作',
  'music.rowPromote': '下一首播放',
  /* 09-18 列表换序:把手的名字 + 落定播报(`ui/list-reorder` 的两句话由消费方给)。
   * 位次对人说的是「第几首」,所以是 1 起,不是下标。 */
  'music.rowDrag': '拖动排序：第 {position} 首',
  'music.rowMoved': '已移至第 {position} 首，共 {total} 首',
  'music.rowUp': '上移',
  'music.rowDown': '下移',
  'music.rowRemove': '移除',
  'music.rowCopy': '复制歌名',
  ...
  'music.rowSayMark': '主持人播报：{say}',
  'music.lyricSeek': '从此句播放：{line}',
  'music.lyricsEmpty': '暂无歌词',
  /* 音乐面 v8 · 唱针读歌词(RecordDeck / DeckRow,2026-09-18) */
  'music.deckStation': '黑豆电台',
  'music.deckOff': '未开启',
  'music.deckSide': '{side} 面 · {n} / {total}',
  'music.deckArmTip': '{side}{n} {name} · {time}',
  'music.deckIntro': '♪ 前奏',
  'music.deckInterlude': '♪ 间奏',
  'music.deckOutro': '♪ 尾奏',
  'music.deckOpen': '开启电台',
  'music.deckContinue': '继续播放',
  'music.petMenu': '和黑豆聊天',
  'music.petSend': '发送',
  'music.petSession': '查看会话',
  'music.deckClose': '关闭电台',
  'music.deckTalk': '和黑豆聊天',
  'music.deckTalkOn': '和黑豆说点什么',
  'music.deckTalkOff': '想听什么？',
  'music.deckFlipAfter': '下一面',
  'music.deckHistory': '播放历史',
  'music.deckLoved': '♥ 已收藏',
  'music.deckSkipped': '已跳过',
  'music.lyricsLoading': '正在加载歌词',
  'music.lyricsFailed': '歌词加载失败',
  'music.deckInvite': '想听什么？',
  'music.deckStarting': '即将播放：{name}',
  /* 四枚心情色块。块上印的是那两个字,按下去发出去的是整句意图(`music.preset.*`)。 */
  'music.mood.rain': '下雨',
  'music.mood.focus': '专注',
  'music.mood.friday': '周五',
  'music.mood.drive': '开车',
  'music.backendNotReady': '音乐服务未就绪，请完成安装并登录。',

  /* ── 跟主持人说话(2026-09-18,正本 §7.2)。说给人听的话:屏上不出现「会话」
   * 「资源」这类实现的名字。{name} 是当前那只宠物的名字 —— 主持人就是它。 */
  'music.talk.placeholder': '和{name}说点什么',
  'music.talk.send': '发送给{name}',
  'music.talk.host': '主持人',
  'music.talk.mood': '换个心情',
  'music.talk.request': '点一首歌',
  'music.talk.what': '现在播放的是什么',
  'music.backendError': '音乐服务出错：{message}',
  'music.playerDisagrees': '操作未生效，已恢复为当前播放状态。',

  /* ── 接入向导(2026-09-18,正本 §6)───────────────────────────────────────
   * 这几句是**说给人听的**,不是实现的名字:屏上不出现「provider」「setupStage」
   * 「资源」这类词。工具的名字(ncm-cli / mpv)是事实不是文案,由后端自述带过来,
   * 不进字典;安装输出、后端的错话同理。 */
  'music.setup.title': '登录网易云音乐',
  'music.setup.envHint': '需要安装以下组件。',
  'music.setup.recheck': '重新检查',
  'music.setup.probing': '检查中…',
  'music.setup.install': '安装',
  'music.setup.installing': '安装中…',
  'music.setup.retry': '重试',
  'music.setup.installed': '已安装 {version}',
  'music.setup.installedPlain': '已安装',
  'music.setup.output': '{tool} 安装日志',
  'music.setup.credentialsHint': '请在网易云音乐开放平台获取 App ID 和私钥。',
  'music.setup.appId': 'App ID',
  'music.setup.privateKey': '私钥',
  'music.setup.revealKey': '显示私钥',
  'music.setup.hideKey': '隐藏私钥',
  'music.setup.save': '保存',
  'music.setup.loginHint': '使用网易云音乐账号登录。',
  'music.setup.loginStart': '开始登录',
  'music.setup.loginStarting': '正在获取二维码…',
  'music.setup.loginRetry': '重试',
  'music.setup.loginFailed': '登录失败，请重试。',
  'music.setup.qrLabel': '登录二维码',
  'music.setup.scanHint': '请使用网易云音乐 App 扫码登录，或在浏览器中打开链接。',
  'music.setup.openInBrowser': '在浏览器中打开',
  'music.setup.copyLink': '复制链接',

  /* 账号菜单(§6.4)。「出声方式」那两句照样例的原话。 */
  'music.account.menu': '账号',
  'music.account.playHere': '本机播放',
  'music.account.playInApp': '网易云音乐 App',
  'music.account.logout': '退出登录',
  'music.account.logoutConfirmTitle': '退出登录？',
  'music.account.logoutConfirmBody': '退出后电台将停止播放，再次使用需要重新扫码登录。',

  /* 音乐面 v9「成熟的音乐 App」(2026-09-25;正本 apps/desktop-react/docs/music-panel-2026-09.md §10)。 */
  'music.navLabel': '音乐导航',
  'music.section.now': '正在播放',
  'music.section.radio': '电台',
  'music.section.search': '搜索',
  'music.section.account': '账号',
  'music.login': '登录',
  'music.nowIdle': '未在播放',
  'music.status.connecting': '正在连接',
  'music.status.unreachable': '无法连接音乐服务',
  'music.status.unreachableHint': '请确认 onething 正在运行，然后重试。',
  'music.status.retry': '重试',
  'music.status.setupEnv': '未完成安装',
  'music.status.setupEnvHint': '需要先安装 ncm-cli 和 mpv。',
  'music.status.setupCredentials': '未配置凭据',
  'music.status.setupCredentialsHint': '请填写网易云开放平台的 App ID 和私钥。',
  'music.status.setupLogin': '未登录',
  'music.status.setupLoginHint': '登录网易云音乐后即可播放。',
  'music.status.goSetup': '去设置',
  'music.status.goLogin': '去登录',
  'music.status.loginWaiting': '等待扫码',
  'music.status.loginWaitingHint': '请使用网易云音乐 App 扫描二维码。',
  'music.status.error': '出错了',
  'music.status.errorHint': '请重试。如果问题仍然存在，请检查登录状态。',
  'music.status.opening': '正在开启电台',
  'music.status.openingHint': '第一首歌大约 1 分钟后开始播放。',
  'music.status.starting': '正在切歌',
  'music.status.playing': '正在播放',
  'music.status.refilling': '正在准备歌曲',
  'music.status.refillingHint': '准备好后将自动继续播放。',
  'music.status.paused': '已暂停',
  'music.status.resumable': '已暂停',
  'music.status.resumableHint': '点击播放，从上次的位置继续。',
  'music.status.stationIdle': '已停止',
  'music.status.stationIdleHint': '点击播放继续收听。',
  'music.status.off': '电台未开启',
  'music.status.offHint': '在「电台」中选择一种心情即可开始。',
  'music.status.goRadio': '开启电台',
  'music.gate.title': '登录后即可使用',
  'music.gate.body': '使用「{section}」需要先登录网易云音乐。',
  'music.gate.step': '当前进度：第 {n}/{total} 步，{title}',
  'music.onboard.title': '登录网易云音乐',
  'music.onboard.lead': '完成以下 3 步即可开始收听。',
  'music.onboard.envTitle': '安装组件',
  'music.onboard.envBody': '安装 ncm-cli 和 mpv。',
  'music.onboard.credentialsTitle': '填写凭据',
  'music.onboard.credentialsBody': '填写网易云开放平台的 App ID 和私钥，仅保存在本机。',
  'music.onboard.loginTitle': '扫码登录',
  'music.onboard.loginBody': '使用网易云音乐 App 扫码登录。',
  'music.onboard.stepDone': '已完成',
  'music.onboard.stepCurrent': '进行中',
  'music.onboard.stepTodo': '未开始',
  'music.station.on': '已开启 · 剩余 {count} 首',
  'music.station.moodsTitle': '选择心情',
  'music.station.moodsHintOff': '点击即可开启电台。',
  'music.station.moodsHintOn': '点击即可切换，当前歌曲不受影响。',
  'music.station.openTitle': '自定义',
  'music.station.openHint': '描述你想听的音乐，例如场景、语言或节奏。',
  'music.station.retuneTitle': '自定义',
  'music.station.opening': '正在开启…',
  'music.station.requestHint': '输入歌名和歌手，将在下一首播放。',
  'music.station.talkTitle': '和主持人聊天',
  'music.station.talkHint': '主持人会回复你，也可能根据你的要求调整歌单。',
  'music.station.talkWaiting': '等待回复…',
  'music.search.placeholder': '搜索歌曲或歌手',
  'music.search.submit': '搜索',
  'music.search.searching': '搜索中…',
  'music.search.hintOff': '电台未开启时，点击「播放」将从这首歌开始电台。',
  'music.search.empty': '未找到「{query}」相关的歌曲。',
  'music.search.results': '「{query}」的搜索结果',
  'music.search.blocked': '暂无版权',
  'music.search.request': '下一首播放',
  'music.search.openWith': '播放',
  'music.search.requestOne': '下一首播放 {name}',
  'music.search.openWithOne': '播放 {name}',
  'music.search.openIntent': '先放「{song}」,然后接着放风格相似的歌',
  'music.search.pickFailed': '「{name}」添加失败：{message}',
  'music.search.capped': '仅显示前 {count} 条结果。',
  'music.account.open': '账号设置',
  'music.account.title': '网易云音乐',
  'music.account.signedIn': '已登录',
  'music.account.listen': '开始收听',
  'music.account.playerTitle': '播放方式',
  'music.account.playerHint': '选择在本机播放，或使用网易云音乐 App 播放。',
  ...
  'pet.heidou.blurb': '住在唱机上的黑猫，眼睛是两张小唱片。',
  'pet.alu.name': '阿绿',
  'pet.alu.blurb': '话不多，爱学你说话的绿鹦鹉。',
  'pet.alu.poked1': '别拽我尾巴。',
  'pet.alu.poked2': '学你：嘿！',
  'pet.alu.waiting1': '放不放？',
  'pet.alu.busy1': '在叼了在叼了。',
  'pet.alu.sleepy1': '……咕。',
  'pet.alu.dizzy1': '羽毛乱了……',
  'pet.alu.annoyed1': '再戳我就学你说话。',
  'pet.alu.stroked1': '咕咕……舒服。',
  'pet.alu.strokedAsleep1': '咕……',
  'pet.alu.woke1': '我醒着我醒着！',
  'pet.alu.liked1': '记住了记住了。',

  /* 设置「宠物」页(P5 §12.4,文案逐字定) */
  'settings.pagePet': '宠物',
  'pet.settings.intro': '住在应用里陪你的那只小家伙。',
  'pet.settings.who': '谁陪你',
  'pet.settings.chattiness': '多久开口一次',
  'pet.settings.quiet': '安静',
  'pet.settings.balanced': '适中',
  'pet.settings.chatty': '话多',
  'pet.settings.quietHint': '只在电台换歌时说话。',
  'pet.settings.balancedHint': '偶尔聊两句。',
  'pet.settings.chattyHint': '有什么说什么。',
  'pet.settings.preview': '让它说句话',
  'pet.settings.previewBusy': '它正在说话。',
  'pet.settings.none': '这台设备上没有宠物。',
  'pet.settings.adoptFailed': '没换成，再点一次试试。',
  'pet.settings.chattinessSaveFailed': '开口频率没存上',

  /* ── 设置「笔记」页(P4;文案由用户 2026-09-18 逐字定,别改）────────────── */
  'settings.pageNotes': '笔记',
  'settings.notesObsidian': 'Obsidian',
  'settings.notesFolders': '其他笔记目录',
  'notes.loading': '正在读取…',
  'notes.loadFailed': '读不到笔记库。',
  'notes.retry': '重试',
  'notes.saveFailed': '这个设置没保存上',
  'notes.stateRunning': 'Obsidian 正在运行。',
  'notes.stateNotRunning': 'Obsidian 没有运行。库按上次读到的设置显示;新建笔记时会启动它。',
  'notes.stateCliNotRegistered': 'Obsidian 的命令行界面没有开启。请在 Obsidian 的「设置 → 通用」里开启后回来。',
  'notes.stateNotInstalled': '没有找到 Obsidian。',
  'notes.useObsidianVaults': '使用 Obsidian 的库',
  'notes.vaultEnabled': '启用',
  'notes.vaultSkills': '技能来源',
  'notes.vaultSkillsHint': '把这个库里的技能目录当作可用技能加载',
  'notes.vaultPrimary': '主库',
  'notes.vaultPrimaryHint': '今天的日记和新建的笔记落在这里',
  'notes.vaultNotOpen': '未在 Obsidian 中打开',
  'notes.vaultsEmpty': 'Obsidian 里还没有库。',
  'notes.foldersHint': '不是 Obsidian 库的普通文件夹。它们同样会被检索和读取。',
  'notes.foldersEmpty': '还没有添加目录。',
  'notes.folderAdd': '添加目录…',
  'notes.folderRemove': '移除',
  'notes.folderMissing': '这个目录不存在',
  'notes.folderIsVault': '这是一个 Obsidian 库,已在上面列出',
  'notes.dailyFormat': '日记文件名格式',
  'notes.dailyFormatHint': '只对上面的目录生效,例如 YYYY-MM-DD',
