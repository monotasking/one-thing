...
export const zh = {
  ...
  'music.deckOutro': '♪ 尾奏',
  'music.deckOpen': '开台',
  'music.deckContinue': '接着放',
  'music.petMenu': '跟黑豆说',
  'music.petSend': '说',
  'music.petSession': '看他在做什么',
  'music.deckClose': '关台',
  'music.deckTalk': '跟黑豆说',
  'music.deckTalkOn': '跟黑豆说点什么',
  'music.deckTalkOff': '今晚想听点什么',
  'music.deckFlipAfter': '翻面以后',
  'music.deckHistory': '放过的',
  'music.deckLoved': '♥ 喜欢',
  ...
  'music.setup.scanHint': '用网易云音乐 App 扫码,或在浏览器里打开这条地址。',
  ...
  'music.navLabel': '音乐分区',
  'music.section.now': '正在放',
  'music.section.radio': '电台',
  'music.section.search': '搜索',
  'music.section.account': '账号',
  'music.login': '登录',
  'music.nowIdle': '没在放',
  'music.status.connecting': '正在连接音乐服务',
  'music.status.unreachable': '连不上音乐服务',
  'music.status.unreachableHint': '音乐服务没有回应。确认 onething 的后端在运行,然后重新连接。',
  'music.status.retry': '重新连接',
  'music.status.setupEnv': '还没装好',
  'music.status.setupEnvHint': '先装两样小工具(ncm-cli 与 mpv),一键就能装。',
  'music.status.setupCredentials': '还差凭据',
  'music.status.setupCredentialsHint': '填上网易云开放平台的 App ID 和私钥。',
  'music.status.setupLogin': '还没登录',
  'music.status.setupLoginHint': '用网易云音乐 App 扫码登录,登上之后就能开台。',
  'music.status.goSetup': '去设置',
  'music.status.goLogin': '去登录',
  'music.status.loginWaiting': '等你扫码',
  'music.status.loginWaitingHint': '用网易云音乐 App 扫码,登上了这边会自己发现。',
  'music.status.error': '出错了',
  'music.status.errorHint': '再按一次试试;还不行的话,去「账号」看看登录是否过期。',
  'music.status.opening': '正在开台',
  'music.status.openingHint': '主持人在挑歌,大约一分钟后放第一首。',
  'music.status.starting': '换歌中',
  'music.status.playing': '正在播放',
  'music.status.refilling': '主持人在补歌单',
  'music.status.refillingHint': '节目单放完了,新的一批马上排好,会自己接着放。',
  'music.status.paused': '已暂停',
  'music.status.resumable': '停在上次',
  'music.status.resumableHint': '按 ▶ 从上次停下的地方接着放。',
  'music.status.stationIdle': '电台开着,但没在出声',
  'music.status.stationIdleHint': '播放器停了,节目单还在。',
  'music.status.off': '电台关着',
  'music.status.offHint': '去「电台」选个心情就能开台。',
  'music.status.goRadio': '去开台',
  'music.gate.title': '登录后就能听歌',
  'music.gate.body': '「{section}」要先接上你的网易云音乐账号。',
  'music.gate.step': '现在在第 {n} 步(共 {total} 步):{title}',
  'music.onboard.title': '三步接上网易云音乐',
  'music.onboard.lead': '接上之后,你的私人电台主持人会按你的口味挑歌、串场,一直放下去。',
  'music.onboard.envTitle': '装工具',
  'music.onboard.envBody': 'ncm-cli 负责和网易云说话,mpv 负责出声。',
  'music.onboard.credentialsTitle': '填凭据',
  'music.onboard.credentialsBody': '网易云开放平台的 App ID 与私钥,只存在这台电脑上。',
  'music.onboard.loginTitle': '扫码登录',
  'music.onboard.loginBody': '用网易云音乐 App 扫一下,登上就好。',
  'music.onboard.stepN': '{n}. {title}',
  'music.onboard.stepDone': '已完成',
  'music.onboard.stepCurrent': '正在这一步',
  'music.onboard.stepTodo': '待办',
  'music.station.on': '开着 · 还剩 {count} 首',
  'music.station.moodsTitle': '选个心情',
  'music.station.moodsHintOff': '点一下就开台,主持人大约一分钟后放第一首。',
  'music.station.moodsHintOn': '点一下就换台:接下来的节目单按新心情重排,正在放的这首不受影响。',
  'music.station.openTitle': '或者说说想听什么',
  'music.station.openHint': '说得越具体越好:场景、语言、节奏都行。',
  'music.station.retuneTitle': '换个方向',
  'music.station.opening': '正在开台…',
  'music.station.requestHint': '说歌名和歌手,主持人会把它排到下一首。',
  'music.station.talkTitle': '跟主持人说句话',
  'music.station.talkHint': '他会回你一两句,也可能照你说的改节目单。',
  'music.station.talkWaiting': '他在想怎么回你…',
  'music.search.placeholder': '搜歌名或歌手',
  'music.search.submit': '搜索',
  'music.search.searching': '搜索中…',
  'music.search.hintOn': '电台开着:点「插到下一首」,这首就排在正在放的后面。',
  'music.search.hintOff': '电台关着:点「用它开台」,先放这首,再接着放相似的歌。',
  'music.search.empty': '没搜到「{query}」,换个说法试试。',
  'music.search.results': '「{query}」的搜索结果',
  'music.search.blocked': '没有版权',
  'music.search.request': '插到下一首',
  'music.search.openWith': '用它开台',
  'music.search.requestOne': '把{name}插到下一首',
  'music.search.openWithOne': '用{name}开台',
  'music.search.openIntent': '先放「{song}」,然后接着放风格相似的歌',
  'music.search.pickFailed': '「{name}」没排上:{message}',
  'music.search.capped': '只列出了前 {count} 首,换个更具体的说法能找得更准。',
  'music.account.open': '账号与出声方式…',
  'music.account.title': '网易云音乐',
  'music.account.signedIn': '已登录',
  'music.account.listen': '去听歌',
  'music.account.playerTitle': '出声方式',
  'music.account.playerHint': '在这台电脑上用 mpv 出声,或者交给已经装好的网易云音乐 App。',
