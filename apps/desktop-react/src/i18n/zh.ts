...
export const zh = {
  ...
  'memory.budgetLabel': '内存占用(相对 hard 线)',
  'memory.budgetLine': '预算 soft {soft} / hard {hard} · core 堆 {heap}',
  ...
  'memory.kindMain': 'core',
  'memory.kindRenderer': '界面',
  'memory.kindBrowser': '网页',
  'memory.kindGpu': 'GPU',
  'memory.kindUtility': '系统服务',
  'memory.kindWorker': '后台线程',
  'memory.kindOther': '其它',
  'memory.holders': '缓存',
  'memory.limit': '上限 {limit}',
