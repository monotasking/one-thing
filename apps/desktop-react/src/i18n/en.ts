...
export const en: Record<MessageKey, string> = {
  ...
  'memory.budgetLabel': 'Memory use (against the hard line)',
  'memory.budgetLine': 'Budget soft {soft} / hard {hard} · core heap {heap}',
  ...
  'memory.kindRenderer': 'Interface',
  'memory.kindBrowser': 'Web page',
  'memory.kindGpu': 'GPU',
  'memory.kindUtility': 'System service',
  'memory.kindWorker': 'Background thread',
  'memory.kindOther': 'Other',
