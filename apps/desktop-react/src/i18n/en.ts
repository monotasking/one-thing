...
export const en: Record<MessageKey, string> = {
  ...
  'music.host': 'Host',
  'music.hostStarting': 'Switching to “{title}” — the host says a few words first.',
  'music.hostNextSay': 'Before the next song: {say}',
  'music.hostQuiet': 'No words planned before the next song.',
  'music.hostCurating': 'The programme is empty; the host is picking songs.',
  'music.armTo': 'Jump to {time}',
