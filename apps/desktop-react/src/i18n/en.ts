...
export const en: Record<MessageKey, string> = {
  ...
  'memory.releaseHint': 'Releases rebuildable caches, including background web pages and idle sessions. They reload on next access.',
  'memory.budgetLabel': 'Memory usage',
  'memory.heapLine': 'Main process JS heap {heap} / {total}',
  ...
  'memory.catWebHint': 'Pages in the built-in browser; each tab and each of its cross-site frames uses its own process',
  'memory.catSystemHint': 'Chromium service processes such as GPU, network and audio',
  'memory.holdersHint': 'Rebuildable caches. Released automatically when memory exceeds the budget, or manually.',
  ...
  'memory.detailSubscribed': '{count} subscribed',
  'memory.detailCapacityPerSession': 'limit {count} per session',
  'memory.detailIdle': '{count} idle',
  'memory.detailProtected': '{count} in use',
  'memory.detailTabs': '{count} tabs',
  'memory.detailHidden': '{count} in background',
  'memory.detailAudible': '{count} playing audio',
