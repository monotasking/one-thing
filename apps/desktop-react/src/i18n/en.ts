...
export const en: Record<MessageKey, string> = {
  ...
  'search.semanticHint':
    'Builds a vector index over every message in the background. It all runs on this machine — nothing is uploaded. Finding by wording stays on regardless.',
  'search.semanticNeedsModelHint': 'Download the model above first, then this can be turned on.',
  ...
  'search.semanticModelAbsentSize':
    'Not downloaded · about {size} · a small multilingual model that runs on this machine',
  'search.semanticModelDownloading': 'Downloading the model',
  'search.semanticModelDownloadingSize': 'Downloading · {loaded} so far',
  'search.semanticModelDownloadingProgress': 'Downloading · {loaded} / {total} · {percent}%',
  'search.semanticModelReady': 'Downloaded',
  'search.semanticModelReadySize': 'Downloaded · {size} · runs on this machine only',
  'search.semanticModelFailed':
    'It did not download. The reason is in the log (log/app.jsonl, search.index.model).',
  'search.semanticModelFailedReason': 'It did not download: {reason}',
  'search.semanticModelFailedNetwork':
    'It did not download: could not connect — check the network proxy ({reason})',
  'search.semanticModelFailedRuntime':
    'It did not download: the inference runtime will not load on this machine ({reason})',
  'search.semanticModelFailedFiles': 'It did not download: the model files are incomplete ({reason})',
  ...
  'search.semanticModelRemoveBlocked': 'Turn off “Find by meaning” first',
