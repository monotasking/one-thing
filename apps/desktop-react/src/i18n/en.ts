...
export const en: Record<MessageKey, string> = {
  ...
  'composer.workdir': 'Working directory: {path}',
  'composer.workdirUnset': 'Choose working directory',
  ...
  'composer.agentOptionsLoading': 'Connecting to the agent…',
  'composer.agentOptionsFailed': "Couldn't read this agent's options: {error}",
  'composer.agentOptionsRetry': 'Retry',
  'composer.agentOptionsNone': 'This agent has no options to adjust',
  'composer.agentOptionsDraft': 'Takes effect when you send the first message',
  'composer.agentOptionsDraftEmpty': 'After the first message, you can pick its model here',
  'composer.agentOptionFailed': "Couldn't change the agent's setting",
  ...
  'ask.multi': 'multi',
  'ask.reject': 'Decline',
  'ask.failed': 'Could not submit. Please retry.',
  'ask.loadFailed': 'Could not sync pending questions. Reopen this conversation to retry.',
  'ask.sending': 'Submitting…',
  ...
  'item.todo': 'Todo',
  'item.memory': 'Memory',
  'memory.release': 'Release caches',
  'memory.releasing': 'Releasing…',
  'memory.released': 'Released {count} items, about {bytes}',
  'memory.releaseFailed': 'Release failed: {reason}',
  'memory.readFailed': 'Could not read: {reason}',
  'memory.loading': 'Reading…',
  'memory.totalUnknown': 'Total unknown',
  'memory.pressureOk': 'Normal',
  'memory.pressureSoft': 'Above soft limit',
  'memory.pressureHard': 'Above hard limit',
  'memory.pressureUnknown': 'Cannot measure',
  'memory.partial': 'Some processes could not be measured; the total is understated',
  'memory.processes': 'Processes',
  'memory.noProcesses': 'No measurable processes',
  'memory.unmeasured': 'No data',
  'memory.holders': 'Caches',
  'memory.unitSessions': '{count} sessions',
  'memory.unitEvents': '{count} entries',
  'memory.unitViews': '{count} web pages',
  'memory.releaseHint': 'Releases caches that can be rebuilt, including background web pages and sessions not in use. They reload the next time you open them.',
  'memory.budgetLabel': 'Memory usage',
  'memory.overview': 'Memory overview',
  'memory.totalLabel': 'In use',
  'memory.trendWindow': 'Last 5 min',
  'memory.processCount': '{count} in total',
  'memory.trend': 'Usage trend',
  'memory.trendWarming': 'Collecting data',
  'memory.trendSummary': 'Last {minutes} min · low {low} · high {high}',
  'memory.agoNow': 'just now',
  'memory.agoSeconds': '{count}s ago',
  'memory.agoMinutes': '{count} min ago',
  'memory.composition': 'Usage by category',
  'memory.catCore': 'Core',
  'memory.catUi': 'Interface',
  'memory.catWeb': 'Web pages',
  'memory.catSystem': 'System services',
  'memory.catCoreHint': 'Main process: sessions, tool calls, the search index and background tasks',
  'memory.catWebHint': 'Pages open in the built-in browser. Each tab uses one process, and each other site embedded in a page uses another',
  'memory.catSystemHint': 'Chromium service processes such as GPU, network and audio',
  'memory.holdersHint': 'All caches below can be rebuilt. They are released automatically when memory exceeds the limit, or manually with "Release caches".',
  'memory.holderFill': '{name} usage',
  'memory.nameCore': 'Main process',
  'memory.nameNetwork': 'Network service',
  'memory.nameAudio': 'Audio service',
  'memory.nameStorage': 'Storage service',
  'memory.detailSessions': '{count} sessions',
  'memory.detailCapacityPerSession': 'up to {count} per session',
  'memory.detailIdle': '{count} not in use',
  'memory.detailProtected': '{count} in use',
  'memory.detailTabs': '{count} tabs in total',
  'memory.detailHidden': '{count} in the background',
  'memory.detailAudible': '{count} playing sound',
  'memory.detailHibernated': 'released automatically {count} times',
  'memory.hardLine': 'Hard limit',
  'memory.softLine': 'Soft limit',
  'memory.catUiHint': 'Renderer process of the app window',
  ...
  'chat.images.group': '{count} images',
  'chat.image.view': 'View {name}',
  ...
  'chat.ref.fillCommand': 'Put {command} in the composer',
  'chat.ref.fillCommandFailed': 'This conversation has no composer right now',
  'chat.ref.openLinkFailed': "Couldn't open this link",
  ...
  'search.semanticHint': 'When the exact words find nothing, look for similar meaning.',
  ...
  'search.semanticStatusUnsupported': 'Not available in this version',
  'search.semanticStatusNeedsModel': 'Download the model first',
  ...
  'search.semanticStatusFailed': "Didn't start",
  'search.semanticStatusFailedReason': "Didn't start: {reason}",
  'search.semanticStatusFailedNetwork': "Didn't start: can't connect. Check the network proxy.",
  'search.semanticStatusFailedRuntime': "Didn't start: this machine can't run the model.",
  'search.semanticStatusFailedModel': "Didn't start: model files are incomplete. Download again.",
  'search.semanticModelLabel': 'Model',
  'search.semanticModelUnknown': 'Checking…',
  'search.semanticModelAbsent': 'Not downloaded',
  'search.semanticModelAbsentSize': 'Not downloaded · about {size}',
  'search.semanticModelDownloading': 'Downloading the model',
  'search.semanticModelDownloadingSize': '{loaded} downloaded',
  'search.semanticModelDownloadingProgress': '{loaded} / {total} · {percent}%',
  'search.semanticModelReady': 'Downloaded',
  'search.semanticModelReadySize': 'Downloaded · {size}',
  'search.semanticModelFailed': 'Download failed',
  'search.semanticModelFailedReason': 'Download failed: {reason}',
  'search.semanticModelFailedNetwork': "Download failed: can't connect. Check the network proxy.",
  'search.semanticModelFailedRuntime': "Download failed: this machine can't run the model.",
  'search.semanticModelFailedFiles': 'Download failed: files are incomplete. Try again.',
  'search.semanticModelDownload': 'Download',
  'search.semanticModelRetry': 'Retry',
  ...
  'network.enable': 'Use network proxy',
  'network.hint': 'Automatically saved. Applies to new app and built-in browser requests without restarting.',
  'network.url': 'Proxy address',
  'network.urlHint': 'Supports HTTP, HTTPS and SOCKS5. Saves after typing pauses, on blur, or on Enter.',
  'network.bypass': 'Bypass proxy for',
  'network.bypassHint': 'Separate hosts with semicolons or commas, e.g. localhost;127.0.0.1;*.local.',
  'network.urlRequired': 'Enter a proxy address before enabling the proxy.',
  'network.urlInvalid': 'Enter a valid proxy address, e.g. http://127.0.0.1:7890.',
  'network.urlProtocol': 'Use an http://, https:// or socks5:// address.',
  'network.loading': 'Loading proxy settings…',
  'network.loadFailed': 'Could not load proxy settings',
  'network.saveFailed': 'Not saved. Your changes are kept; please retry.',
  'network.pending': 'Changes pending…',
  'network.unsavedInvalid': 'Not saved. Fix the proxy address to apply your changes.',
  'network.enabledStatus': 'Saved · Proxy enabled',
  'network.disabledStatus': 'Saved · Proxy disabled; using a direct connection',
  'network.retry': 'Retry',
  'network.retrySave': 'Retry saving',
  'network.test': 'Test connection',
  'network.testing': 'Testing…',
  'network.testHint': 'Checks access to Google’s connectivity endpoint; times out after 10 seconds.',
  'network.testSuccess': 'Connection successful',
  'network.testFailed': 'Connection failed',
  ...
  'diff.changeAt': 'Change {k} of {n}',
  'diff.fileBinary': 'Binary file — nothing to show',
  'diff.fileTruncated': 'This file is large; only the first 1 MiB was read',
  'diff.rowMenu': 'Change actions',
  'diff.menuOpenChange': 'Open change',
  'diff.menuOpenFile': 'Open file in viewer',
  ...
  'drag.hint.splitLeft': 'Split to the left',
  'drag.hint.splitRight': 'Split to the right',
  'drag.hint.splitTop': 'Split above',
  'drag.hint.splitBottom': 'Split below',
  ...
  'files.retry': 'Retry',
  'files.bind': 'Bind…',
  'files.bindTitle': 'Choose working directory',
  ...
  'providers.reasoningConfigure': 'Customize reasoning',
  'providers.reasoningHint': 'Choose supported levels and a default. Leave names blank to use standard labels. Changes apply to the next request.',
  'providers.reasoningLevels': 'Available levels and names',
  'providers.reasoningLevelName': 'Display name for {level}',
  'providers.reasoningDefault': 'Default reasoning level',
  'providers.reasoningToggleable': 'This model supports disabling reasoning',
  'providers.reasoningDefaultOn': 'Enable reasoning by default',
  'providers.reasoningMapping': 'Advanced: request parameter mapping',
  'providers.reasoningMappingHint': 'Inherit provider settings, use the built-in adapter, or map custom API fields. Supports effortPath, effortValues, disabledValue, enabledBody, disabledBody.',
  'providers.reasoningMappingMode': 'Parameter mapping mode',
  'providers.reasoningMappingInherit': 'Inherit provider settings',
  'providers.reasoningMappingNative': 'Use built-in adapter',
  'providers.reasoningMappingCustom': 'Custom mapping',
  'providers.reasoningInvalid': 'Enter valid mapping JSON: effortPath must be a field path; effortValues must contain text or numbers.',
  'providers.reasoningSave': 'Save reasoning settings',
  'providers.reasoningReset': 'Reset reasoning settings',
  'composer.thinkAlwaysOn': 'Reasoning is always enabled for this model',
  ...
  'providers.overrideFoot': 'Window and capabilities save automatically',
  ...
  'music.playerIdle': 'The player isn’t running.',
  'music.intentPlaceholder': 'What do you want to hear? e.g. rainy day, quiet Chinese folk',
  'music.intentNow': '“{intent}”',
  'music.open': 'Start radio',
  'music.retune': 'Switch',
  'music.retuneOpen': 'Switch…',
  'music.retuneHint': 'Switching creates a new playlist. The current song won’t be affected.',
  'music.preset.rain': 'Rainy day, something quiet',
  'music.preset.focus': 'Coding, fewer vocals',
  'music.preset.friday': 'Friday night, winding down',
  'music.preset.drive': 'Driving home late',
  'music.radioResume': 'Resume',
  'music.radioLeft': '{count} songs left',
  'music.radioStop': 'Stop radio',
  'music.requestPlaceholder': 'Song title and artist',
  'music.request': 'Request',
  'music.programme': 'Up next',
  'music.programmeCount': 'Up next · {count} songs',
  'music.programmeEmpty': 'The playlist is empty.',
  'music.upNext': 'Next: {title}',
  'music.starting': 'Switching to: {title}',
  'music.programmeMore': '{count} more not shown',
  'music.armLabel': 'Tonearm',
  'music.rowMore': 'More actions',
  'music.rowPromote': 'Play next',
  /* 09-18 列表换序:把手的名字 + 落定播报(`ui/list-reorder` 的两句话由消费方给)。
   * 位次对人说的是「第几首」,所以是 1 起,不是下标。 */
  'music.rowDrag': 'Drag to reorder: song {position}',
  'music.rowMoved': 'Moved to position {position} of {total}',
  'music.rowUp': 'Move up',
  'music.rowDown': 'Move down',
  'music.rowRemove': 'Remove',
  ...
  'music.rowSayMark': 'Host announcement: {say}',
  'music.lyricSeek': 'Play from this line: {line}',
  'music.lyricsEmpty': 'No lyrics',
  /* Music panel v8 · the needle reads the lyrics (RecordDeck / DeckRow, 2026-09-18) */
  'music.deckStation': 'Heidou Radio',
  'music.deckOff': 'Off',
  'music.deckSide': 'Side {side} · {n} / {total}',
  'music.deckArmTip': '{side}{n} {name} · {time}',
  'music.deckIntro': '♪ Intro',
  'music.deckInterlude': '♪ Interlude',
  'music.deckOutro': '♪ Outro',
  'music.deckOpen': 'Start radio',
  'music.deckContinue': 'Resume',
  'music.petMenu': 'Chat with Heidou',
  'music.petSend': 'Send',
  'music.petSession': 'View session',
  'music.deckClose': 'Stop radio',
  'music.deckTalk': 'Chat with Heidou',
  'music.deckTalkOn': 'Say something to Heidou',
  'music.deckTalkOff': 'What do you want to hear?',
  'music.deckFlipAfter': 'Next side',
  'music.deckHistory': 'History',
  'music.deckLoved': '♥ Liked',
  'music.deckSkipped': 'Skipped',
  'music.lyricsLoading': 'Loading lyrics',
  'music.lyricsFailed': 'Couldn’t load lyrics',
  'music.deckInvite': 'What do you want to hear?',
  'music.deckStarting': 'Up next: {name}',
  ...
  'music.backendNotReady': 'The music service isn’t ready. Complete setup and sign in.',

  /* Talking to the host (2026-09-18). {name} is the current pet — it IS the host. */
  'music.talk.placeholder': 'Say something to {name}',
  'music.talk.send': 'Send to {name}',
  'music.talk.host': 'the host',
  'music.talk.mood': 'Change the mood',
  'music.talk.request': 'Request a song',
  'music.talk.what': 'What’s playing now?',
  'music.backendError': 'Music service error: {message}',
  'music.playerDisagrees': 'The action didn’t take effect. Showing the current playback state.',

  /* Setup wizard (2026-09-18). */
  'music.setup.title': 'Sign in to NetEase Cloud Music',
  'music.setup.recheck': 'Check again',
  'music.setup.envHint': 'The following components are required.',
  'music.setup.probing': 'Checking…',
  'music.setup.install': 'Install',
  'music.setup.installing': 'Installing…',
  'music.setup.retry': 'Try again',
  'music.setup.installed': 'Installed {version}',
  'music.setup.installedPlain': 'Installed',
  'music.setup.output': '{tool} install log',
  'music.setup.credentialsHint': 'Get your App ID and private key from the NetEase Cloud Music open platform.',
  'music.setup.appId': 'App ID',
  'music.setup.privateKey': 'Private key',
  'music.setup.revealKey': 'Show private key',
  'music.setup.hideKey': 'Hide private key',
  'music.setup.save': 'Save',
  'music.setup.loginHint': 'Sign in with your NetEase Cloud Music account.',
  'music.setup.loginStart': 'Start sign-in',
  'music.setup.loginStarting': 'Getting QR code…',
  'music.setup.loginRetry': 'Try again',
  'music.setup.loginFailed': 'Sign-in failed. Please try again.',
  'music.setup.qrLabel': 'Sign-in QR code',
  'music.setup.scanHint': 'Scan with the NetEase Cloud Music app, or open the link in a browser.',
  'music.setup.openInBrowser': 'Open in browser',
  'music.setup.copyLink': 'Copy link',

  /* Account menu. */
  'music.account.menu': 'Account',
  'music.account.playHere': 'This device',
  'music.account.playInApp': 'NetEase Cloud Music app',
  'music.account.logout': 'Sign out',
  'music.account.logoutConfirmTitle': 'Sign out?',
  'music.account.logoutConfirmBody': 'The radio will stop. You’ll need to scan the QR code again to sign in.',

  /* 音乐面 v9「成熟的音乐 App」(2026-09-25;正本 apps/desktop-react/docs/music-panel-2026-09.md §10)。 */
  'music.navLabel': 'Music navigation',
  'music.section.now': 'Now Playing',
  'music.section.radio': 'Radio',
  'music.section.search': 'Search',
  'music.section.account': 'Account',
  'music.login': 'Sign in',
  'music.nowIdle': 'Not playing',
  'music.status.connecting': 'Connecting',
  'music.status.unreachable': 'Can’t connect to the music service',
  'music.status.unreachableHint': 'Make sure onething is running, then try again.',
  'music.status.retry': 'Try again',
  'music.status.setupEnv': 'Setup incomplete',
  'music.status.setupEnvHint': 'Install ncm-cli and mpv first.',
  'music.status.setupCredentials': 'Credentials not set',
  'music.status.setupCredentialsHint': 'Enter your App ID and private key from the NetEase open platform.',
  'music.status.setupLogin': 'Not signed in',
  'music.status.setupLoginHint': 'Sign in to NetEase Cloud Music to start playing.',
  'music.status.goSetup': 'Set up',
  'music.status.goLogin': 'Sign in',
  'music.status.loginWaiting': 'Waiting for scan',
  'music.status.loginWaitingHint': 'Scan the QR code with the NetEase Cloud Music app.',
  'music.status.error': 'Something went wrong',
  'music.status.errorHint': 'Try again. If the problem continues, check your sign-in status.',
  'music.status.opening': 'Starting radio',
  'music.status.openingHint': 'The first song will start in about a minute.',
  'music.status.starting': 'Switching songs',
  'music.status.playing': 'Playing',
  'music.status.refilling': 'Preparing songs',
  'music.status.refillingHint': 'Playback will continue automatically when ready.',
  'music.status.paused': 'Paused',
  'music.status.resumable': 'Paused',
  'music.status.resumableHint': 'Press play to continue from where you left off.',
  'music.status.stationIdle': 'Stopped',
  'music.status.stationIdleHint': 'Press play to continue listening.',
  'music.status.off': 'Radio is off',
  'music.status.offHint': 'Pick a mood under Radio to get started.',
  'music.status.goRadio': 'Start radio',
  'music.gate.title': 'Sign in to continue',
  'music.gate.body': 'Sign in to NetEase Cloud Music to use {section}.',
  'music.gate.step': 'Step {n} of {total}: {title}',
  'music.onboard.title': 'Sign in to NetEase Cloud Music',
  'music.onboard.lead': 'Complete these 3 steps to start listening.',
  'music.onboard.envTitle': 'Install components',
  'music.onboard.envBody': 'Install ncm-cli and mpv.',
  'music.onboard.credentialsTitle': 'Enter credentials',
  'music.onboard.credentialsBody': 'Enter your App ID and private key from the NetEase open platform. They are stored on this device only.',
  'music.onboard.loginTitle': 'Scan to sign in',
  'music.onboard.loginBody': 'Scan the QR code with the NetEase Cloud Music app.',
  'music.onboard.stepDone': 'Done',
  'music.onboard.stepCurrent': 'In progress',
  'music.onboard.stepTodo': 'Not started',
  'music.station.on': 'On · {count} songs left',
  'music.station.moodsTitle': 'Choose a mood',
  'music.station.moodsHintOff': 'Click to start the radio.',
  'music.station.moodsHintOn': 'Click to switch. The current song won’t be affected.',
  'music.station.openTitle': 'Custom',
  'music.station.openHint': 'Describe the music you want, such as a scene, language, or tempo.',
  'music.station.retuneTitle': 'Custom',
  'music.station.opening': 'Starting…',
  'music.station.requestHint': 'Enter a song and artist to play it next.',
  'music.station.talkTitle': 'Chat with the host',
  'music.station.talkHint': 'The host will reply and may adjust the playlist based on your request.',
  'music.station.talkWaiting': 'Waiting for a reply…',
  'music.search.placeholder': 'Search songs or artists',
  'music.search.submit': 'Search',
  'music.search.searching': 'Searching…',
  'music.search.hintOff': 'When the radio is off, “Play” starts the radio from that song.',
  'music.search.empty': 'No songs found for “{query}”.',
  'music.search.results': 'Results for “{query}”',
  'music.search.blocked': 'Unavailable',
  'music.search.request': 'Play next',
  'music.search.openWith': 'Play',
  'music.search.requestOne': 'Play {name} next',
  'music.search.openWithOne': 'Play {name}',
  'music.search.openIntent': 'Play “{song}” first, then keep going with songs in a similar style',
  'music.search.pickFailed': 'Couldn’t add “{name}”: {message}',
  'music.search.capped': 'Showing the first {count} results.',
  'music.account.open': 'Account settings',
  'music.account.title': 'NetEase Cloud Music',
  'music.account.signedIn': 'Signed in',
  'music.account.listen': 'Start listening',
  'music.account.playerTitle': 'Playback',
  'music.account.playerHint': 'Play on this device, or use the NetEase Cloud Music app.',
  ...
  'pet.heidou.blurb': 'A black cat living on the turntable, with two tiny records for eyes.',
  'pet.alu.name': 'Alu',
  'pet.alu.blurb': 'A quiet green parrot that likes to repeat what you say.',
  'pet.alu.poked1': 'Don’t pull my tail.',
  'pet.alu.poked2': 'Copying you: hey!',
  'pet.alu.waiting1': 'Playing or not?',
  'pet.alu.busy1': 'Grabbing it, grabbing it.',
  'pet.alu.sleepy1': '…coo.',
  'pet.alu.dizzy1': 'My feathers are a mess…',
  'pet.alu.annoyed1': 'Poke me again and I’ll repeat everything you say.',
  'pet.alu.stroked1': 'Coo coo… that’s nice.',
  'pet.alu.strokedAsleep1': 'Coo…',
  'pet.alu.woke1': 'I’m awake, I’m awake!',
  'pet.alu.liked1': 'Got it, got it.',

  /* settings "Pet" page (P5 §12.4, copy fixed word for word) */
  'settings.pagePet': 'Pet',
  'pet.settings.intro': 'The little one that keeps you company in the app.',
  'pet.settings.who': 'Who keeps you company',
  'pet.settings.chattiness': 'How often it talks',
  'pet.settings.quiet': 'Quiet',
  'pet.settings.balanced': 'Balanced',
  'pet.settings.chatty': 'Chatty',
  'pet.settings.quietHint': 'Only speaks between songs on the radio.',
  'pet.settings.balancedHint': 'Chats now and then.',
  'pet.settings.chattyHint': 'Says what’s on its mind.',
  'pet.settings.preview': 'Hear it talk',
  'pet.settings.previewBusy': 'It’s already talking.',
  'pet.settings.none': 'No pet on this device.',
  'pet.settings.adoptFailed': 'Couldn’t switch. Try again.',
  'pet.settings.chattinessSaveFailed': 'Couldn’t save how often it talks',

  /* ── settings "Notes" page (P4; copy fixed word for word by the user) ───── */
  'settings.pageNotes': 'Notes',
  'settings.notesObsidian': 'Obsidian',
  'settings.notesFolders': 'Other note folders',
  'notes.loading': 'Loading…',
  'notes.loadFailed': "Couldn't read your note vaults.",
  'notes.retry': 'Retry',
  'notes.saveFailed': 'That setting did not save',
  'notes.stateRunning': 'Obsidian is running.',
  'notes.stateNotRunning': "Obsidian isn't running. Vaults show their last-known settings; creating a note will launch it.",
  'notes.stateCliNotRegistered': "Obsidian's command line interface is off. Turn it on under Settings → General in Obsidian, then come back.",
  'notes.stateNotInstalled': 'Obsidian was not found.',
  'notes.useObsidianVaults': 'Use Obsidian vaults',
  'notes.vaultEnabled': 'On',
  'notes.vaultSkills': 'Skills',
  'notes.vaultSkillsHint': 'Load skill folders in this vault as skills',
  'notes.vaultPrimary': 'Primary',
  'notes.vaultPrimaryHint': "Today's note and new notes go here",
  'notes.vaultNotOpen': 'Not open in Obsidian',
  'notes.vaultsEmpty': 'No vaults in Obsidian yet.',
  'notes.foldersHint': "Plain folders that aren't Obsidian vaults. They're searched and readable all the same.",
  'notes.foldersEmpty': 'No folders added.',
  'notes.folderAdd': 'Add folder…',
  'notes.folderRemove': 'Remove',
  'notes.folderMissing': "This folder doesn't exist",
  'notes.folderIsVault': 'This is an Obsidian vault and is already listed above',
  'notes.dailyFormat': 'Daily note file name',
  'notes.dailyFormatHint': 'Applies to the folders above only, e.g. YYYY-MM-DD',
