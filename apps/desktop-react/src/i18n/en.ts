...
export const en: Record<MessageKey, string> = {
  ...
  'memory.pressureOk': 'Within budget',
  'memory.pressureSoft': 'Over the soft line',
  'memory.pressureHard': 'Over the hard line',
  'memory.pressureUnknown': 'Unknown',
  'memory.partial': 'Some processes could not be measured; the total is low',
  'memory.processes': 'Processes',
  'memory.noProcesses': 'No process could be measured',
  'memory.unmeasured': 'Unmeasured',
  'memory.holders': 'Caches',
  'memory.unitSessions': '{count} sessions',
  'memory.unitEvents': '{count} events',
  'memory.unitViews': '{count} web pages',
  'memory.releaseHint': 'Ask every cache to drop what it can rebuild: web pages left in the background, idle session caches. The next open of each is a little slower.',
  'memory.budgetLabel': 'Memory use and budget',
  'memory.heapLine': 'core JS heap {heap} / {total}',
  'memory.overview': 'Memory overview',
  'memory.totalLabel': 'In use',
  'memory.trendWindow': 'last 5 min',
  'memory.processCount': '{count} processes',
  'memory.trend': 'Recent trend',
  'memory.trendWarming': 'The curve appears in a few seconds',
  ...
  'memory.composition': 'Where it goes',
  'memory.catCore': 'Core',
  'memory.catUi': 'Interface',
  'memory.catWeb': 'Web pages',
  'memory.catSystem': 'System services',
  'memory.catCoreHint': 'The main process: sessions, tools, the search index and background work live here',
  'memory.catUiHint': "This window's own renderer process",
  'memory.catWebHint': 'Pages open in the built-in browser, one process per tab (each cross-site frame counts separately)',
  'memory.catSystemHint': 'Chromium service processes such as GPU, network and audio',
  'memory.holdersHint': 'Caches that can be rebuilt. They are released automatically over budget, or by hand with the button at the top right.',
  'memory.holderFill': '{name}: used / limit',
