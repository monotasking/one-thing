...
export const en: Record<MessageKey, string> = {
  ...
  'music.resume': 'Play',
  'music.next': 'Next',
  'music.skip': 'Skip (fewer like this)',
  'music.like': 'Save to NetEase library',
  'music.liked': 'Saved to NetEase library',
  ...
  'music.retune': 'Retune',
  'music.retuneOpen': 'Retune…',
  'music.retuneHint': 'Retuning makes the host redo the rest of the programme; the song playing now keeps going.',
  ...
  'music.radioResume': 'Resume this station',
  'music.radioLeft': '{count} songs left',
  'music.radioStop': 'Stop station',
  ...
  'music.deckContinue': 'Continue',
  'music.petMenu': 'Talk to Heidou',
  'music.petSend': 'Send',
  'music.petSession': 'See what he is doing',
  'music.deckClose': 'Turn off',
  'music.deckTalk': 'Talk to Heidou',
  'music.deckTalkOn': 'Tell Heidou something',
  'music.deckTalkOff': 'What do you feel like tonight?',
  'music.deckFlipAfter': 'After the flip',
  'music.deckHistory': 'Played',
  ...
  'music.navLabel': 'Music sections',
  'music.section.now': 'Now playing',
  'music.section.radio': 'Radio',
  'music.section.search': 'Search',
  'music.section.account': 'Account',
  'music.login': 'Sign in',
  'music.nowIdle': 'Nothing playing',
  'music.status.connecting': 'Connecting to the music service',
  'music.status.unreachable': 'Can’t reach the music service',
  'music.status.unreachableHint': 'The music service is not answering. Make sure the onething backend is running, then reconnect.',
  'music.status.retry': 'Reconnect',
  'music.status.setupEnv': 'Not set up yet',
  'music.status.setupEnvHint': 'Install two small tools first (ncm-cli and mpv) — one click each.',
  'music.status.setupCredentials': 'Credentials missing',
  'music.status.setupCredentialsHint': 'Enter the App ID and private key from the NetEase open platform.',
  'music.status.setupLogin': 'Not signed in',
  'music.status.setupLoginHint': 'Scan the code with the NetEase Cloud Music app; once you are in, you can start the radio.',
  'music.status.goSetup': 'Set up',
  'music.status.goLogin': 'Sign in',
  'music.status.loginWaiting': 'Waiting for your scan',
  'music.status.loginWaitingHint': 'Scan with the NetEase Cloud Music app — this side notices on its own once you are in.',
  'music.status.error': 'Something went wrong',
  'music.status.errorHint': 'Try again; if it keeps failing, check under Account whether the sign-in expired.',
  'music.status.opening': 'Starting the station',
  'music.status.openingHint': 'The host is picking songs; the first one plays in about a minute.',
  'music.status.starting': 'Changing songs',
  'music.status.playing': 'Playing',
  'music.status.refilling': 'The host is refilling the programme',
  'music.status.refillingHint': 'The programme ran out; the next batch is being lined up and will play on its own.',
  'music.status.paused': 'Paused',
  'music.status.resumable': 'Stopped last time',
  'music.status.resumableHint': 'Press ▶ to continue where you left off.',
  'music.status.stationIdle': 'The station is on but silent',
  'music.status.stationIdleHint': 'The player stopped; the programme is still there.',
  'music.status.off': 'The station is off',
  'music.status.offHint': 'Pick a mood under Radio to start the station.',
  'music.status.goRadio': 'Start the radio',
  'music.gate.title': 'Sign in to start listening',
  'music.gate.body': '“{section}” needs your NetEase Cloud Music account first.',
  'music.gate.step': 'You are on step {n} of {total}: {title}',
  'music.onboard.title': 'Connect NetEase Cloud Music in three steps',
  'music.onboard.lead': 'Once connected, your personal radio host picks songs to your taste, talks between them, and keeps it going.',
  'music.onboard.envTitle': 'Install tools',
  'music.onboard.envBody': 'ncm-cli talks to NetEase; mpv makes the sound.',
  'music.onboard.credentialsTitle': 'Enter credentials',
  'music.onboard.credentialsBody': 'The App ID and private key from the NetEase open platform, kept on this computer only.',
  'music.onboard.loginTitle': 'Scan to sign in',
  'music.onboard.loginBody': 'Scan once with the NetEase Cloud Music app and you are in.',
  'music.onboard.stepN': '{n}. {title}',
  'music.onboard.stepDone': 'Done',
  'music.onboard.stepCurrent': 'In progress',
  'music.onboard.stepTodo': 'To do',
  'music.station.on': 'On · {count} songs left',
  'music.station.moodsTitle': 'Pick a mood',
  'music.station.moodsHintOff': 'One click starts the station; the host plays the first song in about a minute.',
  'music.station.moodsHintOn': 'One click retunes: the rest of the programme is rebuilt for the new mood; the current song is not affected.',
  'music.station.openTitle': 'Or say what you want to hear',
  'music.station.openHint': 'The more specific the better: a scene, a language, a tempo.',
  'music.station.retuneTitle': 'Change direction',
  'music.station.opening': 'Starting…',
  'music.station.requestHint': 'Name a song and artist; the host lines it up next.',
  'music.station.talkTitle': 'Talk to the host',
  'music.station.talkHint': 'He answers in a line or two, and may rework the programme as you ask.',
  'music.station.talkWaiting': 'He is thinking of a reply…',
  'music.search.placeholder': 'Search songs or artists',
  'music.search.submit': 'Search',
  'music.search.searching': 'Searching…',
  'music.search.hintOn': 'The station is on: “Play next” lines the song up right after the current one.',
  'music.search.hintOff': 'The station is off: “Start radio with it” plays this song, then similar ones.',
  'music.search.empty': 'Nothing found for “{query}”. Try other words.',
  'music.search.results': 'Results for “{query}”',
  'music.search.blocked': 'Not licensed',
  'music.search.request': 'Play next',
  'music.search.openWith': 'Start radio with it',
  'music.search.requestOne': 'Play {name} next',
  'music.search.openWithOne': 'Start the radio with {name}',
  'music.search.openIntent': 'Play “{song}” first, then keep going with songs in a similar style',
  'music.search.pickFailed': '“{name}” was not lined up: {message}',
  'music.search.capped': 'Only the first {count} songs are listed; more specific words find it faster.',
  'music.account.open': 'Account and playback…',
  ...
  'music.account.playerHint': 'Play on this computer through mpv, or hand it to the installed NetEase Cloud Music app.',
